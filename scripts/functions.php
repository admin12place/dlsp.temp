...
$tab_rooms = [
    'sienne' => [
        ...
        'room-text' => 'Toute la lingerie est 100% coton.<br/>
                        Des couvertures et des oreillers supplémentaires sont à votre disposition dans la penderie.<br/>
                        Savon, shampoing et linge de toilette sont fournis, un sèche-cheveux complète l\'équipement de la salle de bain.<br/>
                        Un lit parapluie est disponible sur demande pour un enfant de moins de 2 ans.<br/>Une kitchenette est à votre disposition sur la terrasse.'
    ],

    'alizarine' => [
        'position' => 'pair-room',
        'img-alt' => 'Des lits sur la place, chambre Alizarine',
        'img-src' => './images/WP_1051.jpg',
        'room-title' => 'Chambre Alizarine',
        'room-text' => 'Lorem ipsum dolor sit amet. Et facere nulla ea reprehenderit natus ut cupiditate deleniti qui 
        dignissimos natus. Et voluptate facere eum quis iure est recusandae explicabo eum corporis quis. 
        Id adipisci pariatur vel quia placeat et soluta nihil hic dolor soluta! Sit officia omnis aut quia 
        voluptatem et magnam dolorum vel atque aliquam.'
    ],
...
<p>Et faire son lit sur la place...</p>
<p>Nous vous proposons toute l\'année cinq jolies chambres dans notre maison de village du 19eme siècle, chacune de 
caractère mais offrant toutes un confort d\'aujourd\'hui. Vous pourrez profiter de la terrasse pour des petits 
déjeuners au soleil, ou dans la salle commune les autres jours.</p>
<p>Les chambres peuvent accueillir de deux à quatre personnes et nous mettons à votre disposition des lits pour les 
enfants de moins de deux ans.<br/>
Les prix des chambres s\'échelonnent de 82 à 97€ la nuit pour 2 personnes, petit déjeuner compris.</p>';
